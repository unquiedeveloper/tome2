...
function About() {
  return (
    <div className="bg-gradient-to-r from-white-100 to-[#da9858] min-h-screen flex flex-col items-center justify-center">
      <div className="container mx-auto px-6 py-16 flex flex-col lg:flex-row items-center justify-between">
        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left">
          ...
          <p className="mt-2">
            ...
            our community. Join us for a meal that's not just a taste of the 
            Middle East but a journey through its heart and soul.
          </p>
        </div>

        {/* Image Gallery */}
        <div className="w-full lg:w-1/2 flex flex-wrap justify-center lg:justify-end items-center gap-8 mt-12 lg:mt-0">
          <div className="flex flex-col justify-center items-center gap-8 -mt-10 md:-mt-20">
            <img 
              src="https://res.cloudinary.com/di0egnojl/image/upload/v1723787799/tasteofmiddleeast/oerbxnpdtp8sveg8szwd.jpg" 
              alt="Image 1" 
              className="rounded-lg shadow-lg w-32 h-32 md:w-40 md:h-40 object-cover" 
            />
            <img 
              src="https://res.cloudinary.com/di0egnojl/image/upload/v1723787799/tasteofmiddleeast/udw008bz6c6xvup6ubja.jpg" 
              alt="Image 2" 
              className="rounded-lg shadow-lg w-32 h-40 md:w-40 md:h-50 object-cover" 
            />
          </div>
          <div className="flex flex-col justify-center items-center gap-8 mt-10 md:mt-20">
            <img 
          ...
          <div className="flex flex-col justify-center items-center -mt-10 md:-mt-20 gap-8">
            <img 
      ...
      {/* Order Section */}
      <div className="container mx-auto px-6 py-8 text-center mt-12 lg:mt-16">
        <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-6">
          Order Now
        </h2>
        <div className="flex justify-center items-center gap-8">
          <a 
            href="https://www.zomato.com/ncr/taste-of-middle-east-indirapuram-ghaziabad" 
            target="_blank" 
          ...
          <a 
            href="https://www.swiggy.com/city/noida-1/taste-of-middle-east-vaibhav-khand-indirapuram-rest684084" 
            target="_blank" 
            rel="noopener noreferrer"
          >
            <img 
