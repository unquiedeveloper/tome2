...
import zomato from "../assets/zomato-logo1.jpg"
...
<footer className="bg-[#da9858] text-white lg:grid lg:grid-cols-5">
  ...
  <div className="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8">
    <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
      <div>
        <p>
          <span className="text-xs uppercase tracking-wide text-black"> Call us </span>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <div>
          ...
          <a href='https://www.swiggy.com/city/noida-1/taste-of-middle-east-vaibhav-khand-indirapuram-rest684084' className=''>
          <img  src={swiggy} className='w-[110px]'/>
